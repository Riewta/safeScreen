        ...
        {step === "login" && (
          <>
            ...
            <div className="mt-6 flex items-center gap-3">
              <div className="flex-1 h-px bg-[var(--km-border)]" />
              <span className="text-[12px] text-[var(--km-text-muted)]">หรือ</span>
              <div className="flex-1 h-px bg-[var(--km-border)]" />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full h-12 rounded-xl border border-[var(--km-border)] flex items-center justify-center gap-3 text-[14px] font-medium text-[var(--km-text)] hover:bg-[var(--km-surface)] transition-colors disabled:opacity-40"
            >
            ...
            <p className="mt-5 text-center text-[13px] text-[var(--km-text-muted)]">
              ยังไม่มีบัญชี?{" "}
              <button
